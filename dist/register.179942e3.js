function e(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},r={},s=t.parcelRequireb12e;null==s&&((s=function(e){if(e in n)return n[e].exports;if(e in r){var t=r[e];delete r[e];var s={id:e,exports:{}};return n[e]=s,t.call(s.exports,s,s.exports),s.exports}var i=new Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){r[e]=t},t.parcelRequireb12e=s),s.register("ijjug",(function(t,n){e(t.exports,"auth",(()=>h)),e(t.exports,"db",(()=>l)),e(t.exports,"storage",(()=>d)),s("fXOuZ");var r=s("7xvHX");s("1tHc5");var i=s("8FA5P");s("etBjH");var o=s("9HrqM");s("aYguL");var a=s("jceyq"),c=s("chB8e");const u=r.initializeApp(c.default),h=i.n(),l=o.getFirestore(u),d=a.getStorage(u)})),s.register("fXOuZ",(function(t,n){e(t.exports,"initializeApp",(()=>s("7xvHX").initializeApp)),e(t.exports,"registerVersion",(()=>s("7xvHX").registerVersion));s("7xvHX");
/**
 * @license
 ...
 * limitations under the License.
 */
function vo(e){e=Ci(e,Ni);const t=Ci(e.firestore,Mi);return _i(Fi(t),e._key).then((n=>So(t,e,n)))}class wo extends mo{constructor(e){super(),this.firestore=e}convertBytes(e){return new ji(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Ni(this.firestore,null,t)}}function _o(e){e=Ci(e,Di);const t=Ci(e.firestore,Mi),n=Fi(t),r=new wo(t);return go(e._query),bi(n,e._query).then((n=>new fo(t,r,e,n)))}function bo(e,t,n){e=Ci(e,Ni);const r=Ci(e.firestore,Mi),s=yo(e.converter,t,n);return Io(r,[Qi(Xi(r),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,kt.none())])}function To(e){return Io(Ci(e.firestore,Mi),[new Vt(e._key,kt.none())])}function Eo(e,t){const n=Ci(e.firestore,Mi),r=Li(e),s=yo(e.converter,t);return Io(n,[Qi(Xi(e.firestore),"addDoc",r._key,s,null!==e.converter,{}).toMutation(r._key,kt.exists(!1))]).then((()=>r))}function Io(e,t){return function(e,t){const n=new E;return e.asyncQueue.enqueueAndForget((async()=>async function(e,t,n){const r=ui(e);try{const e=await function(e,t){const n=_(e),r=M.now(),s=t.reduce(((e,t)=>e.add(t.key)),on());let i;return n.persistence.runTransaction("Locally write mutations","readwrite",(e=>n.ci.Ks(e,s).next((s=>{i=s;const o=[];for(const e of t){const t=Dt(e,i.get(e.key));null!=t&&o.push(new Pt(e.key,t,be(t.value.mapValue),kt.exists(!0)))}return n.Bs.addMutationBatch(e,r,o,t)})))).then((e=>(e.applyToLocalDocumentSet(i),{batchId:e.batchId,changes:i})))}(r.localStore,t);r.sharedClientState.addPendingMutation(e.batchId),function(e,t,n){let r=e.ua[e.currentUser.toKey()];r||(r=new Gt(L)),r=r.insert(t,n),e.ua[e.currentUser.toKey()]=r}(r,e.batchId,n),await ii(r,e.changes),await ds(r.remoteStore)}catch(e){const t=ks(e,"Failed to persist write");n.reject(t)}}(await vi(e),t,n))),n.promise}(Fi(e),t)}function So(e,t,n){const r=n.docs.get(t._key),s=new wo(e);return new ho(e,s,t._key,r,new uo(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
